...
import kr.ac.kumoh.s20260000.spring12jwt.model.SignupRequest
import kr.ac.kumoh.s20260000.spring12jwt.model.User
import kr.ac.kumoh.s20260000.spring12jwt.model.UserRole
import kr.ac.kumoh.s20260000.spring12jwt.repository.UserRepository
...
class UserService(
    ...
    fun signup(request: SignupRequest): User {
        ...
        // TEST ONLY!!!
        // TODO: BCryptPasswordEncoder 반드시 사용할 것
        // val encodedPassword = encoder.encode(request.password)
        val encodedPassword = request.password
